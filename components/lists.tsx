...
import { defaultLists, formatDate, getNumberFromString, StateContext } from '../pages/_app';
...
export default function Lists(props) {
  ...
  const { items, setItems, lists, setLists, updates, setUpdates, user, devEnv, setPage, setUser, showLeaders, setShowLeaders } = useContext<any>(StateContext);
