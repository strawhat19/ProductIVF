...
const withPWA = require('next-pwa')({
  ...
  runtimeCaching: [
    // HTML/doc pages (prefer fresh, fall back to cache)
    {
...
const routes = {
  ...
  signup: { redirects: [`new`, `sign-up`, `register`, `registration`, `subscribe`], icons: { fontAwesome: `fa-user-plus`, mui: `PersonAdd` } },
